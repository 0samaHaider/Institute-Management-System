<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="WebApplication5.Teacher" %>
<head>
...
<div class="sidebar" >
    ...
    <br />
    <br />
    <asp:Button ID="Button1" runat="server" Height="49px" OnClick="Button1_Click" Text="View Timetable" Width="199px" BackColor="#0099FF" BorderColor="Black" Font-Bold="True" Font-Size="Medium" ForeColor="Black" />
    <br />
    <br />
    <asp:Button ID="Button2" runat="server" Height="49px" Text="Add Assignment " Width="199px" OnClick="Button2_Click" BackColor="#0099FF" BorderColor="Black" Font-Bold="True" Font-Size="Medium" />
    <br />
    <br />
    <asp:Button ID="Button3" runat="server" Text="Upload Result" Width="199px" OnClick="Button3_Click" BackColor="#0099FF" BorderColor="Black" Font-Bold="True" Font-Size="Medium" ForeColor="Black" Height="49px" />
    <br />
    <br />
    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Mark Attendance " Width="199px" BackColor="#0099FF" BorderColor="Black" Font-Bold="True" Font-Size="Medium" ForeColor="Black" Height="49px" />
    <br />
    <br />
